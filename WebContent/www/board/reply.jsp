				...
				<tr>
					<td align="center">
						<table border="0">
							...
							<tr>
								<td width="20%">내 용</td>
								<td width="80%"><textarea name="content" rows="12"
										cols="50">
      	<%=content%>
      	========답변 글을 쓰세요.=======
      	</textarea></td>
			...
			<input type="hidden" name="nowPage" value="<%=nowPage%>"> <input
				type="hidden" name="ref" value="<%=bBean.getRef()%>"> <input
				type="hidden" name="pos" value="<%=bBean.getPos()%>"> <input
				type="hidden" name="depth" value="<%=bBean.getDepth()%>">
		</form>
	</div>
</body>
</html>